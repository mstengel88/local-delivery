...
export default [
  ...
  route("ghos-sso", "routes/ghos-sso.ts"),
  ...
  route("app/custom-quote", "routes/app.custom-quote.tsx"),
  route("app/quote-review", "routes/app.quote-review.tsx"),
  ...
  route("api/dispatch-version", "routes/api.dispatch-version.ts"),
  route("api/driver-location", "routes/api.driver-location.ts"),
  route("api/ghos-sso-link", "routes/api.ghos-sso-link.ts"),
  route("api/loader-ticket-preview", "routes/api.loader-ticket-preview.ts"),
